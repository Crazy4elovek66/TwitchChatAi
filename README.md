...
Проект находится в рабочей экспериментальной стадии. Часть внутренних логов и старых документов в репозитории может содержать текст со сломанной кодировкой; новый README и конфигурационные примеры оформлены в UTF-8.
